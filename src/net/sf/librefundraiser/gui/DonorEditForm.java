...
public class DonorEditForm extends Composite {
	...
	public DonorEditForm(Composite parent, int style, DonorTab donorTab) {
		...
		comboState.setItems(new String[] { "Alabama", "Alaska", "Alberta",
				"Arizona", "Arkansas", "British Columbia", "California",
				...
				"New York", "Newfoundland", "North Carolina", "North Dakota",
		...
		txtNotes = new Text(tabFolder, SWT.BORDER | SWT.WRAP | SWT.V_SCROLL
				| SWT.MULTI);
