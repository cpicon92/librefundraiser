...
public class AboutDialog extends Dialog {
	...
	private void createContents() {
		...
		lblLogo.setLayoutData(new GridData(SWT.RIGHT, SWT.CENTER, false, false, 1, 2));
		...
		lblWarranty.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
		...
		linkGNU.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 2, 1));
		...
		Link linkSite = new Link(compositeInfo, SWT.NONE);
		linkSite.setLayoutData(new GridData(SWT.FILL, SWT.CENTER, true, false, 1, 1));
