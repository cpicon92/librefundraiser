...
public class EditForm extends Composite {
	...
	public EditForm(Composite parent, int style, DonorTab donorTab) {
		...
		tltmAddALink.setImage(SWTResourceManager.getImage(EditForm.class, "/icons/add-link.png"));
		...
		tltmAdd.setImage(SWTResourceManager.getImage(EditForm.class, "/icons/new-gift.png"));
		tltmAdd.setText("Add");
		...
		tltmEdit.setImage(SWTResourceManager.getImage(EditForm.class, "/icons/edit-gift.png"));
		tltmEdit.setEnabled(false);
		tltmEdit.setText("Edit");
		
		ToolItem tltmDelete = new ToolItem(tbrGifts, SWT.NONE);
		tltmDelete.setImage(SWTResourceManager.getImage(EditForm.class, "/icons/delete-gift.png"));
